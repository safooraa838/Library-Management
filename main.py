...
mc=ms.connect(host='localhost',user='root',password='radhika', database='library')
cr=mc.cursor()
chk=None
count=None
ch=None
                                    ...
                                    if ch2==1:
                                        ...
                                        while c1!=0:
                                            for details in data1:
                                                if user in details:
                                                    ...
                                                    update="update log_in set PASSWORD='"+passwrd+"' where
                                                  NAME= '"+user+"'"  
                                                    cr.execute(update)
                                                    mc.commit()
                                        ...
                                        while c2!=0:
                                            for details in data1:
                                                ...
                                                sno=str(len(data1)+1)
                                                values="insert into log_in values ('"+sno+"' , '"+newlogin+"' , 
                                                '"+newpassword+"')"
                                                cr.execute(values)
                                                mc.commit()
                                    ...
                                    if ch3==1:
                                        ...
                                        while c3!=0:
                                            for details in data2:
                                                ...
                                                newstatus="available"
                                                newbook="insert into books values ('"+bookno+"' , '"+bookname+"' , 
                                                '"+authorname+"' , '"+newstatus+"')"
                                                cr.execute(newbook)
                                                mc.commit()
                                        ...
                                        available ="select B_NAME,B_AUTHOR from books where 
                                        status='available' "
                                            ...
                                            for details in data2:
                                                    if name4 in details:
                                                        if details[3]=='available':
                                                            ...
                                                            b_no= str(details[0])
                                                            status='available'
                                                            return_book1 ="update books set STATUS= '"+status+"' where 
                                                            B_NAME= '"+name4+"' "
                                                            return_book2 ="update student set IB_NO= NULL where 
                                                           IB_NO='"+b_no+"' "
                                    ...
                                    if ch4==1:
                                        ...
                                        while c4!=0:
                                            for details in data3:
                                                ...
                                                newstudent="insert into student values ('"+rollno+"' , 
                                                '"+studentname1+", NULL)"
                                        ...
                                        #DELETE STUDENT
                                        studentname2=input("Enter the name of the student that has to be 
                                        deleted: ")
                                        ...
                                        while c5!=0:
                                            for details in data3:
                                                    if studentname2 in details:
                                                        delete="delete from student where S_NAME= 
                                                         '"+studentname2+"' "
                                                        cr.execute(delete)
                                                        mc.commit()
                                        ...
                                        #SEARCH STUDENT
                                        studentname3=input("Enter the name of the student that has to be 
                                        searched: ")            
                                        ...
                                        while True:
                                            ...
                                            if ch5==1:
                                                ...
                                                studentname4=input("Enter the name of the student whose roll 
                                                    ...
                                                    for details in data3:
                                                        if studentname4 in details:
                                                            ...
                                                            if str(details[0])==rollno4:
                                                                ...
                                                                update_s ="update student set ROLL_NO= '"+rollno4+"' 
                                                               where S_NAME= '"+studentname4+"' "	
                                                                cr.execute(update_s)
                                                                mc.commit()
                                            ...
                                            for details in data2:
                                                    if bookname5 in details:
                                                        if details[3]=='issued':
                                                            ...
                                                            b_no= str(details[0])
                                                            status='issued'
                                                            issue_book1 ="update books set STATUS= '"+status+"' where 
				  B_NAME= '"+bookname5+"' "
issue_book2 ="update student set IB_NO= '"+b_no+"' where S_NAME= "+student+"' "
